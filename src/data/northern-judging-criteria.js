...
export const judgingCriteria = {
  ...
  "execution_standards": {
    "rotation_calculation": {
      ...
      "requirements": [
        {
          "chinese": "跳跃动作转体两脚落地或跳跃动作转体下落接弓步、马步、仆步、跌竖叉，均以起跳时两脚之间连线和落地时两脚之间连线的夹角来计算转体度数",
          "english": "For jumping techniques with rotation landing on two feet; or landing into Gōng Bù (Bow Stance), Mǎ Bù (Horse Stance), Pū Bù (Crouching Stance), Diē Shù Chā (Falling Front Split); the calculation of degree of rotation is based on the angle formed by the line between both feet at the time of takeoff and at the time of landing"
        },
        {
    ...
    "run_up_rules": {
      ...
      "requirements": [
        ...
        {
          "chinese": "在跳跃动作之间，表10-3-7中没有注明连接步数的均为前一个跳跃动作两脚同时落地后立即起跳",
          "english": "For jumping techniques, if the number of the connection steps are not indicated in Table 10-3-7, it means that the second jumping technique must be executed immediately after landing with both feet from the previous jumping technique"
        }
      ]
    },
    "connection_rules": {
      ...
      "requirements": [
        {
          "chinese": "连接动作必须是表10-3-7中规定的内容",
          "english": "The connections movements must be the compulsory content described in Table10-3-7"
        },
        {
          "chinese": "动静连接的连接动作完成时必须呈静止状态，且手法或器械方法清晰（在长拳类主要动作中选择）",
          "english": "The connections movements between Dynamic + Static movements must be exibit a motionless state when fully completed. The hand techniques or weapon techniques must be clear and correct (They should be selected from the main techniques of Changquan category)"
        },
        {
          "chinese": "器械套路中的套嵌连接只能选做一种",
          "english": "Only 1 throw-and-catch Degree of Difficulty technique may be selected per weapon routine"
        }
      ]
    },
      ...
      "requirements": [
        {
          ...
          "english": "Should a Degree of Difficulty technique be unsuccessfully executed, then its preceding or the following Degree of Difficulty connection may not be confirmed"
        },
        {
        ...
        {
          "chinese": "借助器械撑地完成平衡动作难度，其动作难度不予确认",
          "english": "The Degree of Difficulty for a balance will not be confirmed as successful if the technique was completed with the use of a weapon for additional support"
        },
        {
