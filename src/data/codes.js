...
export const connections = [
  ...
  { from: '323A', to: '353B', points: 0.1, grade: 'A', description: 'Tornado Kick 360° + Butterfly Twist 360° (within 4 steps)' },
  ...
  { from: '335A', to: '4', points: 0.1, grade: 'A', description: 'Aerial Cartwheel + Falling Front Split' },
  { from: '335A', to: '353B', points: 0.1, grade: 'A', description: 'Aerial Cartwheel + Butterfly Twist 360° (within 4 steps)' },
  ...
  { from: '323A', to: '3', points: 0.15, grade: 'B', description: 'Tornado Kick 360° + Single Raised-Knee Stance' },
  ...
  { from: '323B', to: '4', points: 0.15, grade: 'B', description: 'Tornado Kick 540° + Falling Front Split' },
  { from: '323B', to: '6', points: 0.15, grade: 'B', description: 'Tornado Kick 540° + Cross-Legged Sitting' },
  ...
  { from: '323B', to: '3', points: 0.2, grade: 'C', description: 'Tornado Kick 540° + Single Raised-Knee Stance' },
  ...
  { from: '323C', to: '6', points: 0.2, grade: 'C', description: 'Tornado Kick 630°(F)/720° + Cross-Legged Sitting' },
  { from: '324B', to: '0', points: 0.2, grade: 'C', description: 'Jumping Lotus Kick 540° + Crouching Stance' },
  { from: '324B', to: '3', points: 0.2, grade: 'C', description: 'Jumping Lotus Kick 540° + Single Raised-Knee Stance' },
  { from: '324C', to: '6', points: 0.2, grade: 'C', description: 'Jumping Lotus Kick 630°(F)/720° + Cross-Legged Sitting' },
  { from: '333A', to: '353C', points: 0.2, grade: 'C', description: 'Butterfly Kick + Butterfly Twist 720° (within 4 steps)' },
  { from: '353B', to: '323C', points: 0.2, grade: 'C', description: 'Butterfly Twist 360° + Tornado Kick 630°(F)/720° (within 4 steps)' },
  { from: '335A', to: '323C', points: 0.2, grade: 'C', description: 'Aerial Cartwheel + Tornado Kick 630°(F)/720° (within 4 steps)' },
  { from: '335A', to: '353C', points: 0.2, grade: 'C', description: 'Aerial Cartwheel + Butterfly Twist 720° (within 4 steps)' },
